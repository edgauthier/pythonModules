...
# Based on the answer here: # http://stackoverflow.com/questions/3696642/reading-a-cr2-raw-canon-image-header-using-python
...
def GetDateTimeFromCR2(fname):
    with open(fname, "rb") as f:
        ...
        return "".join(datetime_string).split('\0',1)[0] # combine into string and ignore anything after null

if __name__ == '__main__':
    print GetDateTimeFromCR2('IMG_2393 2.CR2')
